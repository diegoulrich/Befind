...
import { db, shopsTable, shopProductsTable } from "@workspace/db";
      ...
      "products": [
        {
          ...
          "marginHint": "e.g. 'Coût ~6 CHF · Marge ~75%'",
...
- Prices are realistic retail prices as plain decimal strings (no currency symbol), assume CHF.
